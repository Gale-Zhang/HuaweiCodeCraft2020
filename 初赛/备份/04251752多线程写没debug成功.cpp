...
void writeData() {
    ...
    ans.data3456 = (char*)malloc(6 * 11 * num3456);
    ans.data7[0] = (char*)malloc(7 * 11 * num7 / 2);
    ans.data7[1] = (char*)malloc(7 * 11 * num7 / 2);
    ans.data7[2] = (char*)malloc(7 * 11 * num7 / 2);
    memset(ans.offset, 0, 4 * sizeof(int));
    ans.t[0] = new int[4]{0,0,0,0};
    ans.t[0][0] = ((ab.len[0][4] / 7) / 3) * 7;
    cout<<ab.len[0][4]<<endl;
    while(ab.ans[4][0][ans.t[0][0] - 7] == ab.ans[4][0][ans.t[0][0]]) ans.t[0][0] += 7;
    ...
    while(ab.ans[4][0][ans.t[1][0] - 7] == ab.ans[4][0][ans.t[1][0]]) ans.t[1][0] += 7;
