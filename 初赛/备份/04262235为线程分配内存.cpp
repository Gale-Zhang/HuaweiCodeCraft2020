...
void *check(void *arg) {
    ...
    bool *visit = mem.visit + idx * VNUM;
    char *distance = mem.distance + idx * VNUM;
    int *update = mem.update + idx * 125000;
    int *path = mem.path + idx * 7;
